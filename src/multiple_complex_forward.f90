submodule (complex_transform_routines) multiple_complex_forward
...
contains
    ...
    module subroutine cfftmf(lot, jump, n, inc, c, lenc, wsave, lensav, work, lenwrk, ierror)
        ...
        call cmfm1f(lot,jump,n,inc,c,work,wsave,wsave(iw1),wsave(iw2))
...
end submodule multiple_complex_forward
